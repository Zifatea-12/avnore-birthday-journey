...
var styles_default = "/assets/styles-SBTLkbcv.css";
//#endregion
...
var Route$1 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "A special birthday journey for Avnore"
			},
			{
				name: "author",
				content: "Rhea Satvika"
			},
			{
				property: "og:type",
				content: "website"
...
var $$splitComponentImporter = () => import("./routes-qNJu1Tl-.js");
//#endregion
...
var rootRouteChildren = { IndexRoute: createFileRoute("/")({
	head: () => ({ meta: [
		...
		{
			property: "og:title",
			content: "A Little Birthday Journey for Avnore"
		},
		{
